...
description: Terms for using OpenSimGear website, content, links, and related project services.
template: splash
---
...
Please read these terms of service ("Terms") carefully before using {config.site} website (the "Service") operated by
{config.brand.join('')} ("us", "we", or "our").
...
{config.brand.join('')} and its licensors. The Service is protected by copyright, trademark, and other laws of both
Germany and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service
without the prior written consent of {config.brand.join('')}.
...
{config.brand.join('')} has no control over and assumes no responsibility for, the content, privacy policies, or
practices of any third-party websites or services. You further acknowledge and agree that {config.brand.join('')} shall
not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in
connection with the use of or reliance on any such content, goods, or services available on or through any such websites
or services.
...
These Terms shall be governed and construed in accordance with the laws of Germany, without regard to its conflict of
law provisions.
