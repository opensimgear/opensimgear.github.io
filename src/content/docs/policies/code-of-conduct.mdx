...
description:
  Community standards and reporting process for respectful participation in OpenSimGear spaces and contributions.
template: splash
---
...
<a href={`mailto:${config.contacts.abuse}`}>{config.contacts.abuse}</a>. All complaints will be reviewed and
