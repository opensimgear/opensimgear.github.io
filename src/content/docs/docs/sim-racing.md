...
![Logitech G29 Wheel](~/assets/images/docs/logitech-g29-wheel.webp)
...
![Logitech G29 Wheel](~/assets/images/docs/logitech-g29-pedals.webp)
...
![Moza R5 Wheel Base](~/assets/images/docs/moza-r5-wheel-base.webp)
...
![Sim Labs GT1 EVO Sim racing rig](~/assets/images/docs/gt1-evo-sim-racing-cockpit.webp)

or in more expensive setups of custom bent and welded pipes.

![Alpine Racing TRX](~/assets/images/docs/alpine-racing-trxa.webp)
...
![PT Actuator G Belt](~/assets/images/docs/pt-actuator-g-belt.webp)
...
conditions a pilot or driver would face during intense scenarios. The G-Helm aims to increase the realism of simulations
for training or entertainment purposes, allowing users to experience a closer approximation to actual conditions.
...
![DIY Wind Sim](~/assets/images/docs/wind-sim.webp)
...
texture. There are various types of motion simulation platforms but the predominant characteristic that differentiates
them is the degrees of freedom they can simulate.
