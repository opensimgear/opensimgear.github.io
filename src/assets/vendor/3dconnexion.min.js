...
_3Dconnexion.prototype.delete3dmouse = function () {
  ...
  n.viewport !== null &&
    (n.viewport.removeEventListener('focus', n.focus), n.viewport.removeEventListener('blur', n.blur));
  n.session &&
...
_3Dconnexion.ImageItem.base64FromArrayBuffer = function (n) {
  ...
  return (
    e !== 0 &&
      ((i += u[t[f] >> 2]),
      e === 2
        ? ((i += u[((t[f] & 3) << 4) | (t[f + 1] >> 4)]), (i += u[(t[f + 1] & 15) << 2]), (i += '='))
        : ((i += u[(t[f] & 3) << 4]), (i += '=='))),
    i
  );
};
...
(function (n) {
  n ||
    (n = window.console = { log: function () {}, info: function () {}, warn: function () {}, error: function () {} });
...
when = (function (n) {
  ...
  function yt() {
    ...
    var n, i, t;
    return (
      (n = { promise: u, resolve: u, reject: u, notify: u, resolver: { resolve: u, reject: u, notify: u } }),
      (n.promise = i = e(f)),
      n
    );
  }
    ...
    return (
      ...
      (function () {
          ...
          (Array.prototype.indexOf = function (n) {
            ...
            if (
              ...
              arguments.length > 0 &&
                ...
                t !== t
                  ? (t = 0)
                  : t !== 0 && t !== Infinity && t !== -Infinity && (t = (t > 0 || -1) * Math.floor(Math.abs(t)))),
              t >= r)
            )
              return -1;
        ...
        Array.prototype.forEach ||
          (Array.prototype.forEach = function (n, t) {
            ...
            if (((r = new Object(this)), (f = r.length >>> 0), {}.toString.call(n) !== '[object Function]'))
      ...
      (i._sliceUserAgent = function (n, t, i) {
        var s = [],
          ...
          o,
          u;
        for (f < 0 && (f = r.length), e = r.slice(h, f).split(i), o = e[1].split('.'), u = 0; u < o.length; ++u)
      ...
      (i.Session = function (n, t, r, u) {
        ...
        f.log = function () {
          f._options && 'sessionIdent' in f._options
            ? console.group("WAMP Session '" + f._options.sessionIdent + "' [" + f._session_id + ']')
      ...
      (i.Session.prototype.call = function () {
        ...
        for (
          t._calls[r] = n, e = t._prefixes.shrink(arguments[0], !0), u = [i._MESSAGE_TYPEID_CALL, r, e], f = 1;
          f < arguments.length;
          f += 1
        )
          u.push(arguments[f]);
            ...
            n.appkey && n.appkey !== ''
              ? r.authreq(n.appkey, n.appextra).then(function (u) {
                  ...
                  typeof n.appsecret == 'function'
                    ? (f = n.appsecret(u))
                    : ((e = i.deriveKey(n.appsecret, JSON.parse(u).authextra)), (f = r.authsign(u, e)));
