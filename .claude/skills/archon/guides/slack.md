...
Follow the step-by-step instructions in **[docs/slack-setup.md](../../../../../docs/slack-setup.md)** in this
repository.
...
3. Add **Bot Token Scopes**: `app_mentions:read`, `chat:write`, `channels:history`, `channels:join`, `im:history`,
   `im:write`, `im:read`
...
Follow the [Server Setup Guide](server.md) to start the server. The Slack adapter auto-starts when both
